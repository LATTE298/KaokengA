...
- [x] **UI polish (2026-07-10)**: trim รูปไอเทม (เนื้อรูปเต็มกรอบ ไม่ยืดเบี้ยว), การ์ดขาว+ถาดรองแถวไอเทม, แถบโจทย์โชว์รูป+ชื่อผลไม้ที่สุ่มได้
- [x] **ฉากผลไม้ responsive + ขัดเกลา (2026-07-11)**: พื้นหลัง cover-fit ไม่ยืดบน iPad (`cover_fit` flag), โซนถ้วยผูกพิกัดรูป (drop ตรงถ้วยทุกจอ), ถาด/ไอเทมยึดขอบล่างจอเห็นครบทุกอัตราส่วน, การ์ดเล็กลง+เงานุ่ม+เข้าฉาก scale-in, แก้บั๊ก drop ติดเองตอนโหลด
