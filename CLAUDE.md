...
1. **asset 404 — เหลือแค่พื้นหลัง 2 ไฟล์**: `bg_home.webp` (ฉากแยกขยะ) และ `bg_kitchen.webp` (ฉากจัดจานผลไม้) — ไอเทม/thumbnail ทุกอย่างเป็นรูปจริงหมดแล้ว (2026-07-04). ทีมเจนภาพฉากพื้นหลัง 2 ภาพ (แนวนอน 1920×1080) มาวางแล้วลบสองบรรทัดนี้จาก `placeholder_manifest.json`
