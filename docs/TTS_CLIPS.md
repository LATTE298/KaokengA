...
รายการทั้งหมด **225 คลิป** ตรงกับ [`assets/tts/tts_manifest.json`](../assets/tts/tts_manifest.json) แล้ว ไม่ต้องแก้ JSON ใดๆ — แค่วางไฟล์ให้ชื่อตรง (คำศัพท์อิงคลังคำจริง 6 หมวด 90 คำจาก zip "NSC คำศัพท์ + ภาพ") — ชุดบังคับจริงๆ คือ 135 คลิปแรก ส่วน `match_*` 90 คลิปอัดทีหลังได้
...
### สถานการณ์ Module A (23)

เกมสุ่มเป้าหมายใหม่ทุกรอบ ประโยคสั่ง/ใบ้จึง**ประกอบจากชื่อไอเทม** ("น้องช่วยหยิบ_X_ใส่ตะกร้าให้หน่อยนะครับ" / "ลองหยิบ_X_นะครับ") — ต้องอัดครบทุกไอเทม
...
| `sc_ask_milk_carton_blue` | น้องช่วยหยิบนมกล่องสีน้ำเงินใส่ตะกร้าให้หน่อยนะครับ |
| `sc_hint_milk_carton_blue` | ลองหยิบนมกล่องสีน้ำเงินนะครับ |
| `sc_ask_bread_loaf` | น้องช่วยหยิบขนมปังใส่ตะกร้าให้หน่อยนะครับ |
| `sc_hint_bread_loaf` | ลองหยิบขนมปังนะครับ |
| `sc_ask_potato_chips` | น้องช่วยหยิบขนมกรุบกรอบใส่ตะกร้าให้หน่อยนะครับ |
| `sc_hint_potato_chips` | ลองหยิบขนมกรุบกรอบนะครับ |
| `sc_ask_plastic_bottle` | น้องช่วยหยิบขวดพลาสติกใส่ตะกร้าให้หน่อยนะครับ |
| `sc_hint_plastic_bottle` | ลองหยิบขวดพลาสติกนะครับ |
| `sc_ask_food_waste` | น้องช่วยหยิบเศษอาหารใส่ตะกร้าให้หน่อยนะครับ |
| `sc_hint_food_waste` | ลองหยิบเศษอาหารนะครับ |
| `sc_ask_paper_ball` | น้องช่วยหยิบกระดาษใส่ตะกร้าให้หน่อยนะครับ |
| `sc_hint_paper_ball` | ลองหยิบกระดาษนะครับ |
| `sc_ask_banana` | น้องช่วยหยิบกล้วยใส่ตะกร้าให้หน่อยนะครับ |
| `sc_hint_banana` | ลองหยิบกล้วยนะครับ |
| `sc_ask_orange` | น้องช่วยหยิบส้มใส่ตะกร้าให้หน่อยนะครับ |
| `sc_hint_orange` | ลองหยิบส้มนะครับ |
| `sc_ask_apple` | น้องช่วยหยิบแอปเปิ้ลใส่ตะกร้าให้หน่อยนะครับ |
| `sc_hint_apple` | ลองหยิบแอปเปิ้ลนะครับ |
| `sc_ask_grapes` | น้องช่วยหยิบองุ่นใส่ตะกร้าให้หน่อยนะครับ |
| `sc_hint_grapes` | ลองหยิบองุ่นนะครับ |

หมายเหตุ: `tts_celebration/instruction/hint` ในไฟล์ฉากไม่ถูกใช้ตรงๆ (เกมสุ่มเป้าหมายแล้วประกอบประโยคเอง + คำชมสุ่มจาก `sys_celebration_1-3`)
