...
รายการทั้งหมด **65 คลิป** ตรงกับ [`assets/tts/tts_manifest.json`](../assets/tts/tts_manifest.json) แล้ว ไม่ต้องแก้ JSON ใดๆ — แค่วางไฟล์ให้ชื่อตรง
...
| `sys_quiz_start` ★ | ฟังเสียงแล้วเลือกการ์ดที่ถูกต้องนะครับ |
...
★ = เพิ่มเข้ามาพร้อมเกมตอบคำถาม Module C (คำถามในเกมใช้คลิป `word_*` ชุดเดิม ไม่ต้องอัดเพิ่ม)
