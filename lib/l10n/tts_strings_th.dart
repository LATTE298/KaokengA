...
// คำถามแต่ละข้อพูด "คำศัพท์" ตรงๆ (ใช้คลิปเสียงชุดเดียวกับ sound board ได้เลย
// ไม่ต้องอัดประโยคคำถามแยก 30 แบบ) — 4 ประโยคนี้คือเสียงระบบที่เพิ่มเข้ามา

const String kTtsQuizStart = 'ฟังเสียงแล้วเลือกการ์ดที่ถูกต้องนะครับ';
