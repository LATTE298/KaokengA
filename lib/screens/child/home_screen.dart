...
const List<({String label, String title, String body})> _kFooterItems = [
  ...
  (
    ...
    body:
        ...
        '3) เกี่ยวกับโครงงาน\n'
        '• "ก้าวเก่ง" เป็นโครงงานของนักเรียนโรงเรียนยุพราชวิทยาลัย ภายใต้การสนับสนุน'
        'ของสำนักงานพัฒนาวิทยาศาสตร์และเทคโนโลยีแห่งชาติ (สวทช.) พัฒนาเป็น'
        'แอปพลิเคชันช่วยให้เด็กที่มีภาวะดาวน์ซินโดรมได้เรียนรู้ทักษะการใช้ชีวิต'
